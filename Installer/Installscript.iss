...
#define MyAppName "CLavelleTessellationProject"
#define MyAppVersion "0.1"
#define MyAppPublisher "DigiPen Institute of Technology"
#define MyAppURL "http://www.digipen.edu/"
#define MyAppExeName "TessellationProject.exe"
#define MyIconName "TessIco.ico"
...
AppId={{D4E6F283-EF64-4E85-A9A3-B1E87CB7434E}
AppName={#MyAppName}
...
[Icons]
IconFilename: "{#MyIconName}"; Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; 
IconFilename: "{#MyIconName}"; Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"; 
IconFilename: "{#MyIconName}"; Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; 
IconFilename: "{#MyIconName}"; Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; 
